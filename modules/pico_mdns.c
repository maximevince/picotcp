...
pico_mdns_cookie_list_find_query_cookie( const char *name,
...
pico_mdns_res_record_list_find_name_copies( const char *rname,
                                            pico_mdns_res_record_list *records )
{
...
{
    /* TODO: Find currently active query cookie */
