...
END_TEST
START_TEST(tc_mdns_record_cmp_name_type)
{
    struct pico_mdns_record a = {0};
    struct pico_mdns_record b = {0};
    const char *url1 = "foo.local";
...
//
//    /* Try to find the first A record */
//    node_record = pico_mdns_record_tree_find_record(record1, &MyRecords);
//    fail_unless(record1 == node_record,
